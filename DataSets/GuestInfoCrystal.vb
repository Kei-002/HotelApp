...
Public Class GuestInfoCrystal
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "zzzz.GuestInfoCrystal.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedGuestInfoCrystal
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As GuestInfoCrystal = New GuestInfoCrystal()
        rpt.Site = Me.Site
        Return rpt
    End Function
