...
Public Class PaymentReportX
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "zzzz.PaymentReportX.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedPaymentReportX
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As PaymentReportX = New PaymentReportX()
        rpt.Site = Me.Site
        Return rpt
    End Function
