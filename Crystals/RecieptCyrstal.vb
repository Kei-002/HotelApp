...
Public Class RecieptCyrstal
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "zzzz.RecieptCyrstal.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRecieptCyrstal
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RecieptCyrstal = New RecieptCyrstal()
        rpt.Site = Me.Site
        Return rpt
    End Function
